      ...
      <div className="container-app">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            <h4 className="text-xs font-bold tracking-[0.2em] text-brand-900 uppercase">About Us</h4>
          ...
          {/* Quick Links 1 */}
          <div className="space-y-6">
            <h4 className="text-xs font-bold tracking-[0.2em] text-brand-900 uppercase">Quick Links</h4>
            <ul className="space-y-4">
              <li><Link href="#" className="text-[10px] font-medium text-brand-500 hover:text-brand-900 uppercase tracking-widest">Privacy</Link></li>
              <li><Link href="#" className="text-[10px] font-medium text-brand-500 hover:text-brand-900 uppercase tracking-widest">FAQ</Link></li>
              <li><Link href="#" className="text-[10px] font-medium text-brand-500 hover:text-brand-900 uppercase tracking-widest">Shipping</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            <h4 className="text-xs font-bold tracking-[0.2em] text-brand-900 uppercase">Quick Links</h4>
            <ul className="space-y-4">
              <li><Link href="#" className="text-[10px] font-medium text-brand-500 hover:text-brand-900 uppercase tracking-widest">Terms</Link></li>
              <li><Link href="#" className="text-[10px] font-medium text-brand-500 hover:text-brand-900 uppercase tracking-widest">Careers</Link></li>
              <li><Link href="#" className="text-[10px] font-medium text-brand-500 hover:text-brand-900 uppercase tracking-widest">Stores</Link></li>
            </ul>
          </div>

          {/* Newsletter */}
          <div className="space-y-6">
            <h4 className="text-xs font-bold tracking-[0.2em] text-brand-900 uppercase">Newsletter Signup</h4>
